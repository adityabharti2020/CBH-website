...
const AddInput = () => {
  ...
  const handleAddField = () => {
    setInputFields([...inputFields, { floorNo: null, ratePerSqFt: null }]);
  };
  ...
  // ===========================================
  const handleUpdateFloorData = async () => {
    dispatch(isLoading(true));
    try {
